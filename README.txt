...
Использование
Поместите файл index.html на ваш сервер, где он будет доступен по URL.
При необходимости, измените параметры $demandDirectory в файле submit.php для указания пути к директории, где будут храниться файлы заявок.
Откройте страницу с формой заявки в браузере и начните принимать заявки!
